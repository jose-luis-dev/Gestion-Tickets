...
import com.ticketSystem.repository.TicketRepositoryJdbc;
...
public class TicketService {
    ...
    public TicketService() {
        this.ticketRepository = new TicketRepositoryJdbc();
    }
    ...
    public boolean cambiarEstadodeTicket(int idTicket, EstadoOperacional nuevoEstado){
        ...
        Ticket ticketEncontrado = ticketRepository.buscarPorId(idTicket);

        if (ticketEncontrado == null) return false;
    ...
    public boolean cambiarPrioridadTicket(int idTicket, Prioridad prioridad){
        ...
        Ticket ticketEncontrado = obtenerTicketPorId(idTicket);
