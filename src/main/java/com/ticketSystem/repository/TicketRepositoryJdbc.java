...
import com.ticketSystem.config.DatabaseConnection;
...
public class TicketRepositoryJdbc implements ITicketRepository {
    ...
    public List<Ticket> listarTickets() {
        ...
        try (Connection con = DatabaseConnection.getConnection();
            ...
            throw new RuntimeException("Error listado tickets ", e);
        }
        return tickets;
    }
    ...
    public Ticket buscarPorId(int id) {
        ...
        try(Connection con = DatabaseConnection.getConnection();
            ...
            throw new RuntimeException("Error buscando ticket", e);
        }
        return null;
    ...
    public void guardar(Ticket ticket){
        ...
        try (Connection con = DatabaseConnection.getConnection();
            ...
            throw new RuntimeException("Error guardando ticket: ", e);
        }
    }
    ...
    public void actualizar(Ticket ticket) {
        ...
        try(Connection con = DatabaseConnection.getConnection();
            ...
            throw new RuntimeException("Error actualizado ticket", e);
        }
